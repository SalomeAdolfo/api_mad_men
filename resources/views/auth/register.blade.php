                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="segundo_apellido" type="text" class="form-control @error('segundo_apellido') is-invalid @enderror" name="segundo_apellido" value="{{ old('segundo_apellido') }}" required autocomplete="segundo_apellido">
                        ...
                        <div class="row mb-3">
                            <label for="numero_telefono" class="col-md-4 col-form-label text-md-end">{{ __('Número de teléfono')}}</label>
                            <div class="col-md-6">
                                <input type="number" name="numero_telefono" id="numero_telefono" class="form-control @error('numero_telefono') is-invalid @enderror" value="{{ old('numero_telefono') }}" required>
